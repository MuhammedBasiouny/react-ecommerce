    ...
    <div>
      <Row className='justify-content-start '>
        ...
        <Col sm='8'>
          ...
          <input type='text' className='input-form d-block mt-3 px-3' placeholder='اسم المنتج' />
          <textarea
          ...
          />
          <input type='number' className='input-form d-block mt-3 px-3' placeholder='سعر المنتج' />
